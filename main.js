...
document.getElementById('search').addEventListener('click',() => {
    ...
    productName.forEach((itmes, index) => {
        if (itmes.innerText.includes(searchInput))
        {
    ...
    // addEventListener('click')  LẮNG NGHE SỰ KIỆN
    // () => {}                   KHỞI TẠO VÀ CHẠY
    // toUpperCase()                 IN HOA
    // querySelectorAll cards       LẤY TOÀN BỘ 
    // FOREACH :                 VÒNG LẶP CÓ HÀM
    // items và index          Mình tự khởi tạo